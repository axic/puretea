...
contract PureteaTest is Test {
    function testSmoke() public {
        assertEq(Puretea.isPureGlobal(hex""), false); // empty
    ...
    function testCustomMask() public {
        ...
        assertFalse(Puretea.check(hex"", mask));
    ...
    function testMutating() public {
        ...
        assertFalse(Puretea.isMutating(hex""));
    ...
    function testView() public {
        ...
        assertFalse(Puretea.isView(hex""));
    ...
    function testPureGlobal() public {
        ...
        assertFalse(Puretea.isPureGlobal(hex""));
    ...
    function testPureLocal() public {
        ...
        assertFalse(Puretea.isPureLocal(hex""));
